...
import { BarChart3, BookOpen, ClipboardList, FileText, Target, TrendingUp } from "lucide-react";
import Link from "next/link";

export default function DashboardPage() {
    const { data: analytics, loading } = useApiRequest(() => AnalyticsAPI.getDashboardAnalytics(), true);
            ...
            <div className="space-y-8">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        />
                        <AnalyticsCard title="Questions Created" value="0" icon={FileText} subtext="In question bank" />
                    </div>
                )}
                        ...
                        <Card className="p-6">
                            ...
                            {analytics?.strongestTopic ? (
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Your most successful area of study</p>
                                </div>
                            ) : (
                                <p className="text-muted-foreground">Take some tests to see your strongest topics</p>
                            )}
                        </Card>
                        ...
                        <Card className="p-6">
                            ...
                            {analytics?.recentTests && analytics.recentTests.length > 0 ? (
                                ...
                                <div className="text-center py-6">
                                    <p className="text-muted-foreground text-sm">No tests attempted yet</p>
                                    <Link href="/tests/create">
